...
const App = () => {
    ...
    // Serverless Stremio: the streaming server is our in-browser Service
    // Worker at same-origin /stream/ — there is no local device on
    // 127.0.0.1:11470. When the profile still points at the core's factory
    // default (or an empty value), migrate it to the in-browser server once.
    // Users can still add/select remote servers in Settings > Streaming.
    React.useEffect(() => {
