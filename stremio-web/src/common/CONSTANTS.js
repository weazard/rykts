...
// Serverless Stremio: the streaming server is our in-browser Service Worker,
// mounted same-origin under /stream/. No remote device to configure. Falls
// back to the classic local server URL when there's no browser origin (SSR).
const DEFAULT_STREAMING_SERVER_URL =
    typeof window !== 'undefined' && window.location && window.location.origin
        ? new URL('/stream/', window.location.origin).href
