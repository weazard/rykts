    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                ...
                // Serverless Stremio: emit the in-browser streaming engine + its
                // Service Worker at the build root so /local-server-sw.js and its
                // ./engine.js, ./torrent.js, ./store.js, ./frames.js imports
                // resolve same-origin. Single source of truth lives in the
                // sibling serverless-torrent app.
                { from: '../serverless-torrent/public/local-server-sw.js', to: 'local-server-sw.js' },
                { from: '../serverless-torrent/public/engine.js', to: 'engine.js' },
